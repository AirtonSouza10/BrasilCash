...
<body>
		...
		<div class="containner">
            ...
            $meses = $faturaDAO->getContasAPagarMesesBrasil03antigo();
	
            ?>			
			<!--valores por mês e fornecedor-->
            <center><h4>  CONTAS A PAGAR - FORNECEDORES - ÓTICAS BRASIL 00384255000103 - <?php echo $mes_extenso["$mes"]."/".$ano ?> </h4></center>
			<center>
			<table id="pagar">
			  <tbody>
				...
				$mes_extenso = array(
					...
					'December' => 'DEZEMBRO'
                      ...
                      echo "</th>";
	            $faturaDAO = new FaturaDAO();
				$faturas = $faturaDAO->getContasAPagarBrasil03antigo($mescp,$anocp);
				...
				//mostrar totais
	            $faturaDAO = new FaturaDAO();
				$total = $faturaDAO->getContasAPagarTotalBrasil03antigo($mescp,$anocp);
				...
				//mostrar total geral
	            $faturaDAO = new FaturaDAO();
				$totalgeral = $faturaDAO->getContasAPagarTotalGeralBrasil03antigo();
