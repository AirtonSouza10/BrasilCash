...
<body>
        ...
        <!--formulário-->
            <?php 
                ...
                $operador = $operadorDAO->getOperadorById($id);   
            ?>			
		<div class="container">
		  <center><h3>Alteração - Operador </h3></center>
			<form method="POST" action="../controller/alteraOperador.php">
			<ul class="form-style-1">
				<li>
				    <input type="text" class="field-long" name="id" value="<?php echo $operador['id']?>" readonly="readonly" />
				</li>			
				<li>
					<label>Nome <span class="required">*</span>
					</label><input type="text" name="nome" class="field-long"value="<?php echo $operador['nome']?>"/> 
				<li>
					<label>CPF <span class="required">*</span></label>
					<input type="text" name="cpf" class="field-long"value="<?php echo $operador['cpf']?>" />
				</li>
