...
<body>
        ...
        <!--formulário-->		
            ...
            ?>		  
		<div class="container">
		  <center><h3>Alteração - Fornecedor</h3></center>

			<form method="POST" action="../controller/alteraFornecedor.php">
			<ul class="form-style-1">
			
				<li>
				    <input type="text" class="field-long" name="id" value="<?php echo $fornecedor['id']?>" readonly="readonly" />
				</li>			
				<li>
					<label>Razão Social <span class="required">*</span></label>
					<input type="text" name="razao" class="field-long" value="<?php echo $fornecedor['razao']?>"/> 
				</li>
				
				<li>
					<label>Telefone</label>
					<input type="text" name="telefone" class="field-long" value="<?php echo $fornecedor['telefone']?>"/>
				</li>

				<li>
					<label>CNPJ <span class="required">*</span></label>
					<input type="text" name="cnpj" class="field-long"value="<?php echo $fornecedor['cnpj']?>" />
				</li>
