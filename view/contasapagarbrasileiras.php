...
<body>
		...
		<div class="containner">
            ...
            $meses = $faturaDAO->getContasAPagarMesesBrasileiras();
	
            ?>			
			<!--valores por mês e fornecedor-->
            <center><h4>  CONTAS A PAGAR - FORNECEDORES - ÓTICAS BRASILEIRAS - <?php echo $mes_extenso["$mes"]."/".$ano ?> </h4></center>
			<center>
			<table id="pagar">
			  <tbody>
				...
				$mes_extenso = array(
					...
					'December' => 'DEZEMBRO'
                      ...
                      echo "</th>";
	            $faturaDAO = new FaturaDAO();
				$faturas = $faturaDAO->getContasAPagarBrasileiras($mescp,$anocp);
				...
				//mostrar totais
	            $faturaDAO = new FaturaDAO();
				$total = $faturaDAO->getContasAPagarTotalBrasileiras($mescp,$anocp);
				...
				//mostrar total geral
	            $faturaDAO = new FaturaDAO();
				$totalgeral = $faturaDAO->getContasAPagarTotalGeralBrasileiras();
