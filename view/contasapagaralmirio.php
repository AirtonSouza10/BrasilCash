...
<body>
		...
		<div class="containner">
            ...
            $meses = $faturaDAO->getContasAPagarMesesAlmirio();
	
            ?>			
			<!--valores por mês e fornecedor-->
            <center><h4>  CONTAS A PAGAR - FORNECEDORES - ALMIRIO BEZERRA GARCIA - <?php echo $mes_extenso["$mes"]."/".$ano ?> </h4></center>
			<center>
			<table id="pagar">
			  <tbody>
				...
				$mes_extenso = array(
					...
					'December' => 'DEZEMBRO'
                      ...
                      echo "</th>";
	            $faturaDAO = new FaturaDAO();
				$faturas = $faturaDAO->getContasAPagarAlmirio($mescp,$anocp);
				...
				//mostrar totais
	            $faturaDAO = new FaturaDAO();
				$total = $faturaDAO->getContasAPagarTotalAlmirio($mescp,$anocp);
				...
				//mostrar total geral
	            $faturaDAO = new FaturaDAO();
				$totalgeral = $faturaDAO->getContasAPagarTotalGeralAlmirio();
