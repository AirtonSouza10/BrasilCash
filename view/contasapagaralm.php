...
<body>
		...
		<div class="containner">
            ...
            $meses = $faturaDAO->getContasAPagarMesesAlm();
	
            ?>			
			<!--valores por mês e fornecedor-->
            <center><h4>  CONTAS A PAGAR - FORNECEDORES - ÓTICAS ALM EIRELI - <?php echo $mes_extenso["$mes"]."/".$ano ?> </h4></center>
			<center>
			<table id="pagar">
			  <tbody>
				...
				$mes_extenso = array(
					...
					'December' => 'DEZEMBRO'
                      ...
                      echo "</th>";
	            $faturaDAO = new FaturaDAO();
				$faturas = $faturaDAO->getContasAPagarAlm($mescp,$anocp);
				...
				//mostrar totais
	            $faturaDAO = new FaturaDAO();
				$total = $faturaDAO->getContasAPagarTotalAlm($mescp,$anocp);
				...
				//mostrar total geral
	            $faturaDAO = new FaturaDAO();
				$totalgeral = $faturaDAO->getContasAPagarTotalGeralAlm();
