  ...
  <script type="text/javascript" src="js/jquery.mask.min.js"></script>
        ...
        $(document).ready(function(){
                ...
                $("#busca").keyup(function(){
                    var busca = $("#busca").val();
                    $.post('buscabxportitulo.php',{busca: busca},function(data){
...
<body>
		...
		<!--janela modal baixar fatura-->
					...
					<div class="modal-content">
						<div class="modal-body">
							<div class="panel-body">
								<form id="modalExemplo" method="post" action="../controller/baixarFaturaTitulo2.php">
								<table>
								<tr>
									<td>
									<label>ID</label>
			...
			<!--campo de busca-->
                <section class="corpo">
                <h2 class="novo">Busca Título <a href="index.php"><span><a href="../view/fatura.php"><img src="../imagem/adicionar.png" width="30px" height="30px" title="Adicionar novo registro"></a></span></h2>
		...
		<div class="containner" id="result">
            ...
            $faturas = $faturaDAO->getFaturasBxPorTitulo();
            ?>
                  <!--lojas-->
