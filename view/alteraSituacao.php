...
<body>
        ...
        <!--formulario-->
            <?php 
                ...
                $situacao = $situacaoDAO->getSituacaoById($id);   
            ?>		
		
		<div class="container">
		  <center><h3>Alteração - Situação</h3></center>
		  
			<form method="POST" action="../controller/alteraSituacao.php">
			<ul class="form-style-1">
				<li>
				    <input type="text" class="field-long" name="id" value="<?php echo $situacao['id']?>" readonly="readonly" />
				</li>			
			
				<li>
					<label> Status <span class="required">*</span></label>
					<input type="text" name="stattus" class="field-long" value="<?php echo $situacao['stattus']?>" /> 
				</li>
