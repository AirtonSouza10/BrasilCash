...
<body>
        ...
        <!--formulário-->
            <?php 
                ...
                $prazos = $prazosDAO->getPrazoById($id);   
            ?>			
		<div class="container">
		  <center><h3>Alteração - Prazos</h3></center>
			<form method="POST" action="../controller/alteraPrazo.php">
			<ul class="form-style-1">
			
				<li>
				    <input type="text" class="field-long" name="id" value="<?php echo $prazos['id']?>" readonly="readonly" />
				</li>			
			
				<li>
					<label>Descricao <span class="required">*</span></label>
					<input type="text" name="descricao" class="field-long" value="<?php echo $prazos['descricao']?>"/> 
				</li>
				
				<li>
					<label>Dias Prazo <span class="required">*</span></label>
					<input type="text" name="diasdif" class="field-long" value="<?php echo $prazos['diasdif']?>" />
				</li>

				<li>
					<label>Parcelas <span class="required">*</span></label>
					<input type="text" name="qtdepr" class="field-long" value="<?php echo $prazos['qtdepr']?>"/>
				</li>
