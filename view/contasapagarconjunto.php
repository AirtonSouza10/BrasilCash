...
<body>
		...
		<div class="containner">
            ...
            $meses = $faturaDAO->getContasAPagarMesesConjunto();
	
            ?>			
			<!--valores por mês e fornecedor-->
            <center><h4>  CONTAS A PAGAR - FORNECEDORES - ÓTICAS BRASIL - CONJUNTO NACIONAL - <?php echo $mes_extenso["$mes"]."/".$ano ?> </h4></center>
			<center>
			<table id="pagar">
			  <tbody>
				...
				$mes_extenso = array(
					...
					'December' => 'DEZEMBRO'
                      ...
                      echo "</th>";
	            $faturaDAO = new FaturaDAO();
				$faturas = $faturaDAO->getContasAPagarConjunto($mescp,$anocp);
				...
				//mostrar totais
	            $faturaDAO = new FaturaDAO();
				$total = $faturaDAO->getContasAPagarTotalConjunto($mescp,$anocp);
				...
				//mostrar total geral
	            $faturaDAO = new FaturaDAO();
				$totalgeral = $faturaDAO->getContasAPagarTotalGeralConjunto();
